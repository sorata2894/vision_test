...
try:
    ...
    for workspace in 'C:/test_ros/devel;C:/opt/ros/melodic/x64'.split(';'):
...
code = generate_environment_script('C:/test_ros/devel/env.bat')

output_filename = 'C:/test_ros/build/catkin_generated/setup_cached.bat'
