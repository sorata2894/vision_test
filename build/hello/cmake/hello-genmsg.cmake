...
set(MSG_I_FLAGS "-Ihello:C:/test_ros/src/hello/msg;-Istd_msgs:C:/opt/ros/melodic/x64/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "C:/test_ros/src/hello/msg/vision.msg" NAME_WE)
add_custom_target(_hello_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hello" "C:/test_ros/src/hello/msg/vision.msg" ""
)
...
_generate_msg_cpp(hello
  "C:/test_ros/src/hello/msg/vision.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hello)
  install(CODE "execute_process(COMMAND \"C:/opt/ros/melodic/x64/python.exe\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hello\")")
  # install generated code
  install(
